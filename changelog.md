...
- Добавлена частичная поддержка Dailymotion ([34#issuecomment-1533772639](https://github.com/ilyhalight/voice-over-translation/issues/34#issuecomment-1533772639))
  ...
  > [!WARNING]
  > Перед выполнением перевода видео перезагрузите страницу, иначе вы рискуете перевести одно из старых вами просмотренных видео. Я не нашел способа как это исправить.

- после перед началом нового перевода нужно перезагружать страницу, чтобы )
