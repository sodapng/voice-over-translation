# 1.2.0
- Починил работу кнопки при открытие первого видео с главной страницы ютуба (сломалась в 1.1.3 после попытки объединить кнопки от @SashaXse ([ilyhalight/voice-over-translation#142](https://github.com/ilyhalight/voice-over-translation/pull/142))) (Вернул 2 раздельных прослушивателя)
