...
- Добавлена поддержка Facebook (Работает только в открытых видео. В ленте не работает)
...
- Возвращены локализированные описания плагинов (названия будут добавлены позже, как в webpack-userscript исправят баг связанный с ними)
- Webpack-userscript обновлен до 3.2.1. Теперь, cloudflare версия нормально собирается
