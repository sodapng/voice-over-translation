...
- Добавлена поддержка Coursera.
  ...
  P.S.: Перевод некоторых видео может не работать. Точно не знаю с чем связано, например перевод 1-го видео курса "Learning How To Learn" сегодня работает, а завтра уже возвращает "Сервис пока не поддерживается для перевода видео". В то время как перевод других видео курса работает исправно.

  <details>
    <summary><h3>Показ работы с разными курсами</h3></summary>
    <img src="https://i.imgur.com/YJTYkmK.png">
    <img src="https://i.imgur.com/Mua5JYD.png">
  </details>
