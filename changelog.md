...
<!-- TODO: добавить выбор detect и translate сервера -->

# 1.5.0-beta10
- Добавлена опция включающая перевод ошибок возвращаемых с сервера. Работает на базе [Яндекс переводчика](https://github.com/FOSWLY/translate-backend)
...
- Добавлено использование Local Storage заместо GM Storage, если расширение его не поддерживает:
  - Фикс работы в FireMonkey
  - Фикс работы в UserScripts
- Добавлены доп. проверки на существование методов для YouTube player
- Фикс ошибки Hls в Safari
