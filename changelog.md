# 1.3.4 (TESTING!)
<span style="color: #C1234F">Это тестовая версия расширения! Она предназначена, только, для тестирования. Если вы хотите ее использовать, вам будет необходимо собрать расширение вручную или найти собранную версию в "артефактах"</span>
