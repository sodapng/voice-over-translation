...
# 1.5.0-beta4
- Добавлена возможность загрузки субтитров от Яндекса (в формате json)
...
- Добавлено проксирование стримов, дабы не нужно было использовать отдельное расширение для отключения CORS
