...
# 1.5.0-beta10
- Добавлена поддержка Yandex Drive (только публичные ссылки, например: `https://disk.yandex.ru/s/FILE_ID`)
...
- Убраны некоторые дебаг логи и комментарии для тестирования Hls
