...
/* harmony import */ var _config_config_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__("./src/config/config.js");
/* harmony import */ var _config_alternativeUrls_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__("./src/config/alternativeUrls.js");
...
/* harmony import */ var _utils_volume_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__("./src/utils/volume.js");
/* harmony import */ var _config_config_cloudflare_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__("./src/config/config-cloudflare.js");
...
const sitesChromiumBlocked = [..._config_alternativeUrls_js__WEBPACK_IMPORTED_MODULE_14__/* .sitesInvidious */ .a, ..._config_alternativeUrls_js__WEBPACK_IMPORTED_MODULE_14__/* .sitesPiped */ .U];
...
async function main() {
  ...
  async function translateProccessor(videoContainer, siteHostname, siteEvent) {
    ...
    async function changeSubtitlesLang(subs) {
      ...
      if (subs === "disabled") {
        ...
        (0,_subtitles_js__WEBPACK_IMPORTED_MODULE_13__/* .setSubtitlesWidgetContent */ .Bv)(video, await (0,_subtitles_js__WEBPACK_IMPORTED_MODULE_13__/* .fetchSubtitles */ .Hl)(subtitlesList[parseInt(subs)]));
      }
    }
    ...
    async function updateSubtitlesLangSelect() {
      ...
      disabledOption.innerHTML = _localization_localizationProvider_js__WEBPACK_IMPORTED_MODULE_6__/* .localizationProvider */ .V.get("VOTSubtitlesDisabled");
      select.append(disabledOption);
      for (let i = 0; i < subtitlesList.length; i++) {
        const s = subtitlesList[i];
        const option = document.createElement("option");
        option.value = i;
        option.innerHTML = `${_localization_localizationProvider_js__WEBPACK_IMPORTED_MODULE_6__/* .localizationProvider */ .V.get("langs")[s.language] || s.language.toUpperCase()}${s.translatedFromLanguage ? ` ${_localization_localizationProvider_js__WEBPACK_IMPORTED_MODULE_6__/* .localizationProvider */ .V.get("VOTTranslatedFrom")} ${_localization_localizationProvider_js__WEBPACK_IMPORTED_MODULE_6__/* .localizationProvider */ .V.get("langs")[s.translatedFromLanguage] || s.translatedFromLanguage.toUpperCase()}` : ""}${s.source !== "yandex" ? ` ${s.source}` : ""}${s.isAutoGenerated ? ` (${_localization_localizationProvider_js__WEBPACK_IMPORTED_MODULE_6__/* .localizationProvider */ .V.get("VOTAutogenerated")})` : ""}`;
        ...
        if (
          ...
          const checkbox = (0,_menu_js__WEBPACK_IMPORTED_MODULE_8__/* .createMenuCheckbox */ .H0)(
            ...
            _localization_localizationProvider_js__WEBPACK_IMPORTED_MODULE_6__/* .localizationProvider */ .V.get("VOTAutoSetVolume") +
              `${_config_config_js__WEBPACK_IMPORTED_MODULE_15__/* .autoVolume */ .IM * 100}%`
          );
    ...
    function addVideoSlider() {
      ...
      slider.querySelector("#VOTVideoSlider").oninput = async (event) => {
        ...
        const finalValue = (0,_utils_volume_js__WEBPACK_IMPORTED_MODULE_16__/* .syncVolume */ .C)(
          audio,
          value,
          translateVolume,
          tempOriginalVolume
      ...
      translateVideo(
        ...
        async (success, urlOrError) => {
          ...
          if (
            ...
            const proxiedAudioUrl = `https://${_config_config_cloudflare_js__WEBPACK_IMPORTED_MODULE_17__/* .workerHost */ .i}/video-translation/audio-proxy/${audioPath}`;
          ...
          if (
            ...
            setVideoVolume(_config_config_js__WEBPACK_IMPORTED_MODULE_15__/* .autoVolume */ .IM);
          }
          ...
          if (VOTVideoSlider) VOTVideoSlider.value = _config_config_js__WEBPACK_IMPORTED_MODULE_15__/* .autoVolume */ .IM * 100;

          const VOTOriginalVolume =
            document.querySelector("#VOTOriginalVolume");
          if (VOTOriginalVolume) {
            VOTOriginalVolume.innerText = `${_config_config_js__WEBPACK_IMPORTED_MODULE_15__/* .autoVolume */ .IM * 100}%`;
          }
  ...
  async function initWebsite() {
    ...
    if (_config_alternativeUrls_js__WEBPACK_IMPORTED_MODULE_14__/* .sitesInvidious */ .a.includes(window.location.hostname)) {
    ...
    } else if (_config_alternativeUrls_js__WEBPACK_IMPORTED_MODULE_14__/* .sitesPiped */ .U.includes(window.location.hostname)) {
      // Need an additional extension to work in chrome-like browsers
...
await _localization_localizationProvider_js__WEBPACK_IMPORTED_MODULE_6__/* .localizationProvider */ .V.update();
