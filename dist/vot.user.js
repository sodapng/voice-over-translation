...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Az: () => (/* binding */ cfOnlyExtensions),
...
const sitesChromiumBlocked = [..._config_alternativeUrls_js__WEBPACK_IMPORTED_MODULE_16__/* .sitesInvidious */ .a, ..._config_alternativeUrls_js__WEBPACK_IMPORTED_MODULE_16__/* .sitesPiped */ .U];
...
async function main() {
  ...
  if (
    ...
    _config_constants_js__WEBPACK_IMPORTED_MODULE_5__/* .cfOnlyExtensions */ .Az.includes(GM_info.scriptHandler)
  ) {
    console.error(
  ...
  async function initWebsite() {
    ...
    if (_config_alternativeUrls_js__WEBPACK_IMPORTED_MODULE_16__/* .sitesInvidious */ .a.includes(window.location.hostname)) {
    ...
    } else if (_config_alternativeUrls_js__WEBPACK_IMPORTED_MODULE_16__/* .sitesPiped */ .U.includes(window.location.hostname)) {
      // Need an additional extension to work in chrome-like browsers
      ...
      const el = await (0,_utils_utils_js__WEBPACK_IMPORTED_MODULE_4__/* .waitForElm */ .Nc)("#video_player");
      if (el) {
        let videoIDNew;
      ...
      const el = await (0,_utils_utils_js__WEBPACK_IMPORTED_MODULE_4__/* .waitForElm */ .Nc)(".vjs-v7");
      if (el) {
        let videoIDNew;
        ...
        setInterval(async () => {
          ...
          if (videoID !== videoIDNew) {
            const newEl = await (0,_utils_utils_js__WEBPACK_IMPORTED_MODULE_4__/* .waitForElm */ .Nc)(".vjs-v7");
            if (videoIDNew && newEl) {
...
function udemyUtils_getVideoFileURL(sources) {
  const source = sources?.find((src) => src.type === "video/mp4");
  return source?.src;
}
...
async function udemyUtils_getVideoData(udemyData, responseLang = "en") {
  ...
  const videoURL = udemyUtils_getVideoFileURL(lectureData?.asset?.media_sources);
      ...
      if (dbData) {
        ...
        if (
          ...
          btn.onclick = async (event) => {
            ...
            dbUdemyData = udemyData;
            debug/* default */.Z.log("udemyData value changed. New value: ", dbUdemyData);
            window.location.reload();
          };
          menuOptions.appendChild(btn);
        }
