...
/* harmony export */   b: () => (/* binding */ workerHost),
/* harmony export */   c: () => (/* binding */ yandexHmacKey),
/* harmony export */   d: () => (/* binding */ yandexUserAgent)
/* harmony export */ });
// CONFIGURATION
...
async function requestVideoTranslation(
  ...
  try {
    ...
    const key = await window.crypto.subtle.importKey(
      "raw",
      utf8Encoder.encode(config/* yandexHmacKey */.c),
    ...
    const options = {
      ...
      url: `https://${config/* workerHost */.b}/video-translation/translate`,
      method: "POST",
      headers: {
        Accept: "application/x-protobuf",
        "Accept-Language": "en",
        "Content-Type": "application/x-protobuf",
        "User-Agent": config/* yandexUserAgent */.d,
        Pragma: "no-cache",
...
async function src_main() {
  ...
  async function translateProccessor(videoContainer, siteHostname, siteEvent) {
    utils_debug.log("[translateProccessor] execute ", videoContainer);
  ...
  async function initWebsite() {
    if (config_regexes.youtubeRegex.test(window.location.hostname)) {
      utils_debug.log("[entered] YT Regex Passed", config_regexes.youtubeRegex);
      const ytPageEnter = () => {
      ...
      if (window.location.hostname.includes("twitch.tv")) {
        ...
        if (
          ...
          utils_debug.log("[entered] twitch mobile");
