...
async function yandexRequest(
  ...
  try {
    ...
    GM_xmlhttpRequest({
      ...options,
      onload: (http) => {
        _utils_debug_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"].log */ .Z.log("yandexRequest:", http.status, http);
...
async function src_main() {
  ...
  if (
    ...
    const errorText = `[VOT] ${constants/* translations */.Iz[lang].unSupportedExtensionError}`;
